...
#pdf("/home/leej40/Documents/PTC/Code/PTCestimate_n_1500.pdf",6,6)
par(mar=c(5.1,5.1,2,2))
data_to_plot <- list(
  "A" = Output$n_1500_frac_0.1$rho.h,
  "B" = Output$n_1500_frac_0.05$rho.h,
  "C" = Output$n_1500_frac_0.02$rho.h,
  "D" = Output$n_1500_frac_0.01$rho.h
)
#dev.new()
...
mtext(side = 1, 
      ...
      line = 1.5, 
      cex = 1.5)
abline(h = Output$n_1500_frac_0.1$rho, col = "red", lty = 2, lwd = 2)
dev.off()

##  2) n=2000
#pdf("/home/leej40/Documents/PTC/Code/PTCestimate_n_2500.pdf",6,6)
par(mar=c(5.1,5.1,2,2))
data_to_plot <- list(
  "A" = Output$n_2500_frac_0.1$rho.h,
  "B" = Output$n_2500_frac_0.05$rho.h,
  "C" = Output$n_2500_frac_0.02$rho.h,
  "D" = Output$n_2500_frac_0.01$rho.h
)
#dev.new()
boxplot(data_to_plot,
        main = " ",
...
##  3) n=4000
#pdf("/home/leej40/Documents/PTC/Code/PTCestimate_n_4000.pdf",6,6)
par(mar=c(5.1,5.1,2,2))
data_to_plot <- list(
  "A" = Output$n_4000_frac_0.1$rho.h,
  "B" = Output$n_4000_frac_0.05$rho.h,
  "C" = Output$n_4000_frac_0.02$rho.h,
  "D" = Output$n_4000_frac_0.01$rho.h
)
#dev.new()
boxplot(data_to_plot,
        main = " ",
